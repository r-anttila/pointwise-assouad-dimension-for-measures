...
\end{equation}
for all $\mathbf{i}\in\Sigma$. This measure is called the Gibbs measure of the potential $\phi$. Define the Ruelle operator $\Tilde{T}\colon C(\Sigma)\to C(\Sigma)$ of the symbolic representation by
\begin{equation*}
...
\end{thm}
\begin{proof}
Let $s=\max_{i\in\Lambda}\frac{\log p_i}{\log r_i}$. We start by showing that $\adim\mu\leq s$. Let $x\in F$ and $0<r<R<1$. Choose integers $k$ and $l$, such that
\begin{equation*}
