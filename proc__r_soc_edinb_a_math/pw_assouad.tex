...
\begin{example}\label{ex:loc_not_glob_doubling}
    ...
    The fact that $\mu$ is pointwise doubling at $X\setminus\{0\}$ follows from Lemma \ref{lemma:atom}, and a standard calculation shows that for any  $2^{-k}\leq r < 2^{-k+1}$, we have
    \begin{equation*}
